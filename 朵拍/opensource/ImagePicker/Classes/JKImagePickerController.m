...
////    if (rows > 0) {
////        [self.collectionView scrollToItemAtIndexPath:[NSIndexPath indexPathForRow:rows - 1 inSection:0] atScrollPosition:UICollectionViewScrollPositionBottom animated:NO];
////    }
//}
...
{
    if ([_delegate respondsToSelector:@selector(JKImagePickerController:didSelectAssets:isSource:)]) {
        [_delegate JKImagePickerController:self
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        //_collectionView.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin |UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleBottomMargin |UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
