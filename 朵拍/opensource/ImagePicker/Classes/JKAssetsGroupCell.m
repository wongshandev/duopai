...
- (void)setAssetsGroup:(ALAssetsGroup *)assetsGroup{
    if (_assetsGroup != assetsGroup) {
        ...
        self.assetsNameLabel.jk_left = self.thumbnailView.jk_right + 18;
        self.assetsNameLabel.jk_bottom = self.thumbnailView.jk_centerY-2;
        
        self.assetsCountLabel.text = [NSString stringWithFormat:@"%ld", (long)[_assetsGroup numberOfAssets]];
        [self.assetsCountLabel sizeToFit];
        self.assetsCountLabel.jk_left = self.assetsNameLabel.jk_left;
        self.assetsCountLabel.jk_top = self.assetsNameLabel.jk_bottom+4;
...
- (UIImageView *)checkImageView{
    if (!_checkImageView) {
        ...
        _checkImageView.jk_right = self.thumbnailView.jk_width-3;
        _checkImageView.jk_bottom = self.thumbnailView.jk_height-3;
