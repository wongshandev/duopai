...
- (void)setAssetsGroups:(NSArray *)assetsGroups{
    if (_assetsGroups != assetsGroups) {
        ...
        self.tableView.jk_height = rowCount*kHeightAssetsGroupCell;
        self.touchButton.jk_top = self.tableView.jk_bottom;
        self.touchButton.jk_height = self.jk_height - self.tableView.jk_bottom;
        [self.tableView reloadData];
    }
}
...
- (UITableView *)tableView{
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.jk_width, 4*kHeightAssetsGroupCell) style:UITableViewStylePlain];
...
- (UIButton *)touchButton{
    if (!_touchButton) {
        ...
        _touchButton.frame = CGRectMake(0, self.tableView.jk_bottom, self.jk_width, self.jk_height-self.tableView.jk_bottom);
